...
class CLIPConditioner(VideoConditioner):
    ...
    def __init__(self, name: str, output_dim: int, device: str, video_len: int = 30, finetune: bool = False, is_qformer: bool = False, qformer: omegaconf.DictConfig = None):
        ...
        clip_model, _ = clip.load(name, device=device, jit=False, is_qformer=is_qformer, qformer_cfg=qformer)
...
class ConditioningProvider(nn.Module):
    ...
    """
    def __init__(self, conditioners: tp.Dict[str, BaseConditioner], device: tp.Union[torch.device, str] = "cpu", cond_type: tp.Optional[str] = "text"):
        super().__init__()
        self.device = device
